...
- (void)performMigration {
    ...
    if ([axeSyncVersionManager noOldWallet]) {
...
- (void)performCrashReportingForced:(BOOL)forced {
    if (forced) {
        if ([MFMailComposeViewController canSendMail]) {
            ...
            [composeController setToRecipients:@[ @"support@axe.org" ]];
    ...
    UIAlertController *alert = [UIAlertController
                                alertControllerWithTitle:nil
                                message:NSLocalizedString(@"We have detected that Axewallet crashed last time it was opened. Would you like to help us solve the issue by sending us the crash report data? Your transaction history and any other private information WILL NOT be shared.", nil)
                                preferredStyle:UIAlertControllerStyleAlert];
    UIAlertAction *cancelAction = [UIAlertAction
                                    actionWithTitle:NSLocalizedString(@"cancel", nil)
                                    style:UIAlertActionStyleCancel
