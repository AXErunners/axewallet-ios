...
- (void)viewDidLoad {
    ...
    self.availableLabel.attributedText = [self.model availableAxeString];

    UIImage *axeImage = [[UIImage imageNamed:@"Axe-Light"] ds_imageWithTintColor:UIColorFromRGB(0x008DE4)];
    UIImageView *axeImageView = [[UIImageView alloc] initWithImage:axeImage];
    axeImageView.contentMode = UIViewContentModeRight;
    axeImageView.frame = CGRectMake(0.0, 0.0, 26.0, 30.0);
    self.textField.leftView = axeImageView;
