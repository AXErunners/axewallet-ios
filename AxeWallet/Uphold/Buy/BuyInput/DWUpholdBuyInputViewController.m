...
+ (instancetype)controllerWithAxeCard:(DWUpholdCardObject *)axeCard fromCard:(DWUpholdCardObject *)card {
    ...
    controller.model = [[DWUpholdBuyInputModel alloc] initWithAxeCard:axeCard fromCard:card];
...
- (void)viewDidLoad {
    ...
    // TODO: localize
    self.titleLabel.text = @"Buy Axe with Debit/Credit card";
