...
@property (strong, nonatomic) DWUpholdCardObject *axeCard;
...
- (DWUpholdBuyInputViewController *)inputController {
    if (!_inputController) {
        DWUpholdBuyInputViewController *inputController = [DWUpholdBuyInputViewController controllerWithAxeCard:self.axeCard
...
- (void)upholdBuyInputViewController:(DWUpholdBuyInputViewController *)controller
    ...
    DWUpholdConfirmTransferViewController *confirmController =
        [DWUpholdConfirmTransferViewController controllerWithCard:self.axeCard transaction:transaction];
