...
static CGFloat AxeLogoTopPadding(void) {
...
@property (strong, nonatomic) IBOutlet NSLayoutConstraint *axeLogoTopConstraint;
...
- (void)setupView {
    ...
    self.axeLogoTopConstraint.constant = AxeLogoTopPadding();
