...
@property (strong, nonatomic) IBOutlet UIImageView *axeLogoImageView;
@property (strong, nonatomic) IBOutlet UILabel *appVersionLabel;
@property (strong, nonatomic) IBOutlet UILabel *axeSyncVersionLabel;
...
- (void)viewDidLoad {
    ...
    self.axeLogoImageView.tintColor = [UIColor dw_axeBlueColor];
    self.appVersionLabel.font = [UIFont dw_fontForTextStyle:UIFontTextStyleTitle3];
    self.axeSyncVersionLabel.font = [UIFont dw_fontForTextStyle:UIFontTextStyleFootnote];
    ...
    self.axeSyncVersionLabel.text = [self.model axeSyncVersion];
    self.descriptionLabel.text = NSLocalizedString(@"This app is open source:", nil);
    [self.repositoryURLButton setTitle:@"https://github.com/axerunners/axewallet-ios" forState:UIControlStateNormal];
    ...
    self.copyrightLabel.text = NSLocalizedString(@"Copyright © 2020 Axe Core", nil);
...
- (IBAction)respositoryURLAction:(id)sender {
    NSURL *url = [NSURL URLWithString:@"https://github.com/axerunners/axewallet-ios?files=1"];
