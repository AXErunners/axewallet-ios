...
- (NSAttributedString *)axeAmountStringWithFont:(UIFont *)font {
    return [self.dataProvider axeAmountStringFrom:self.dataItem font:font];
}
...
- (NSArray<id<DWTitleDetailItem>> *)inputAddressesWithFont:(UIFont *)font {
    ...
    if ([self shouldDisplayInputAddresses]) {
        ...
        for (NSString *address in addresses) {
            NSAttributedString *detail = [NSAttributedString dw_axeAddressAttributedString:address
                                                                                   withFont:font];
...
- (nullable id<DWTitleDetailItem>)feeWithFont:(UIFont *)font tintColor:(UIColor *)tintColor {
    ...
    NSAttributedString *detail = [NSAttributedString dw_axeAttributedStringForAmount:feeValue
                                                                            tintColor:tintColor
                                                                                 font:font];
