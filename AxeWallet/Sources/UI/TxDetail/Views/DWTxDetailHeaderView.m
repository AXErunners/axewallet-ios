...
- (void)commonInit {
    ...
    self.axeAmountLabel.font = [UIFont dw_fontForTextStyle:UIFontTextStyleHeadline];
...
- (void)setDisplayType:(DWTxDetailDisplayType)displayType {
    ...
    switch (displayType) {
        ...
        case DWTxDetailDisplayType_Received: {
            ...
            iconTintColor = [UIColor dw_axeBlueColor];
...
- (void)reloadAttributedData {
    if (self.displayType == DWTxDetailDisplayType_MasternodeRegistration) {
        ...
        self.axeAmountLabel.attributedText = [model axeAmountStringWithFont:amountFont];
    }
}
