...
+ (UIColor *)dw_axeBlueColor {
    UIColor *color = [UIColor colorNamed:@"AxeBlueColor"];
    NSParameterAssert(color);
    return color;
}

+ (UIColor *)dw_axeNavigationBlueColor {
    UIColor *color = [UIColor colorNamed:@"AxeNavigationBarBlueColor"];
    NSParameterAssert(color);
    return color;
}
