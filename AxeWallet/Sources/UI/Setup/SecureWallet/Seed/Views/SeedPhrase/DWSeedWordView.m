...
static UIColor *BackgroundColor(DWSeedPhraseType type) {
    switch (type) {
        ...
        case DWSeedPhraseType_Select:
            return [UIColor dw_axeBlueColor];
    }
}
...
- (void)animateDiscardedSelectionWithCompletion:(void (^)(void))completion {
    ...
    redColorAnimation.fromValue = (id)[UIColor dw_axeBlueColor].CGColor;
    ...
    blueColorAnimation.toValue = (id)[UIColor dw_axeBlueColor].CGColor;
