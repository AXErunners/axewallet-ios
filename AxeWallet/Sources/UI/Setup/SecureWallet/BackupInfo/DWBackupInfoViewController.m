...
- (NSArray<NSString *> *)items {
    if (!_items) {
        _items = @[
            ...
            NSLocalizedString(@"You will need this recovery phrase to access your funds if this device is lost, damaged or if Axe Wallet ever is accidentally uninstalled from this device.", nil),
        ];
    }
