...
- (void)setupView {
    ...
    switch (self.type) {
        ...
        case DWSecureWalletInfoType_Reminder: {
            descriptionText = NSLocalizedString(@"You received Axe! If you lose this device, you will lose your funds. Get your recovery phrase so that you can restore your wallet on another device.", nil);
            break;
        }
    }
