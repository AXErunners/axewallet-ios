...
- (void)viewDidLoad {
    ...
    self.firstDescriptionLabel.text = NSLocalizedString(@"Buy Axe with Uphold account", nil);
    self.secondDescriptionLabel.text = NSLocalizedString(@"Transfer Axe from your Uphold account to this wallet", nil);
...
- (IBAction)linkUpholdAccountButtonAction:(id)sender {
    ...
    NSString *callbackURLScheme = @"axewallet://";
