...
NSNotificationName const DWNotificationsProviderWillUpdateNotification = @"org.axe.wallet.dp.notifications-will-update";
NSNotificationName const DWNotificationsProviderDidUpdateNotification = @"org.axe.wallet.dp.notifications-did-update";
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self
                                                 selector:@selector(didUpdateContacts)
                                                     name:DWAxePayContactsDidUpdateNotification
                                                   object:nil];
...
- (void)reload {
    ...
    DSBlockchainIdentity *blockchainIdentity = [DWEnvironment sharedInstance].currentWallet.defaultBlockchainIdentity;
    NSManagedObjectID *userID = blockchainIdentity.matchingAxepayUserInViewContext.objectID;
