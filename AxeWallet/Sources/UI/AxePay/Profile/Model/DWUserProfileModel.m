...
#import "DWAxePayContactsActions.h"
...
- (void)update {
    ...
    [[DWAxePayContactsUpdater sharedInstance] fetchWithCompletion:^(BOOL success, NSArray<NSError *> *_Nonnull errors) {
...
- (void)acceptContactRequest {
    ...
    __weak typeof(self) weakSelf = self;
    [DWAxePayContactsActions acceptContactRequest:self.item
...
- (void)updateDataSource {
    ...
    NSAssert(myBlockchainIdentity.matchingAxepayUserInViewContext, @"Invalid DSBlockchainIdentity: myBlockchainIdentity");
    DSAxepayUserEntity *me = [myBlockchainIdentity matchingAxepayUserInContext:context];
    DSAxepayUserEntity *friend = nil;
    if (friendBlockchainIdentity.matchingAxepayUserInViewContext) {
        friend = [friendBlockchainIdentity matchingAxepayUserInContext:context];
    }
