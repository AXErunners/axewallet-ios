...
- (void)configurePlaceholderState {
    ...
    NSAttributedString *subtitle =
        [[NSAttributedString alloc] initWithString:NSLocalizedString(@"Find a user on the Axe Network", nil)
...
- (void)configureSearchingAnimationState {
    ...
    NSString *format = NSLocalizedString(@"Searching for username %@ on the Axe Network", nil);
...
- (void)configureActionButtonForSearchUsers {
    ...
    [self.actionButton setTitle:NSLocalizedString(@"Search for a User on the Axe Network", nil)
