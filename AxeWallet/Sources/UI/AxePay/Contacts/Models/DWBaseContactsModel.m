...
- (void)start {
    if ([self shouldFetchData]) {
        [[DWAxePayContactsUpdater sharedInstance] fetch];
    }
...
- (void)acceptContactRequest:(id<DWDPBasicUserItem>)item {
    [DWAxePayContactsActions acceptContactRequest:item completion:nil];
}

- (void)declineContactRequest:(id<DWDPBasicUserItem>)item {
    [DWAxePayContactsActions declineContactRequest:item completion:nil];
}
