...
#import "DWAxePayAnimationView.h"
#import "DWUIKit.h"
...
@property (null_resettable, strong, nonatomic) DWAxePayAnimationView *progressView;
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor dw_axeBlueColor];
...
- (UIView *)contentView {
    if (_contentView == nil) {
        ...
        contentView.backgroundColor = [UIColor dw_axeBlueColor];
        _contentView = contentView;
    }
    return _contentView;
}

- (DWAxePayAnimationView *)progressView {
    if (_progressView == nil) {
        DWAxePayAnimationView *progressView = [[DWAxePayAnimationView alloc] initWithFrame:CGRectZero];
...
- (UIButton *)actionButton {
    if (_actionButton == nil) {
        ...
        [actionButton setTitleColor:[UIColor dw_axeBlueColor] forState:UIControlStateNormal];
        [actionButton setTitleColor:[[UIColor dw_axeBlueColor] colorWithAlphaComponent:0.5] forState:UIControlStateHighlighted];
...
- (void)updateDetailLabel {
    ...
    NSString *formattedString = [NSString
        stringWithFormat:NSLocalizedString(@"Your username %@ is being created on the Axe Network", nil),
                         self.username];
