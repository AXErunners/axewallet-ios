...
- (NSAttributedString *)attributedTitle {
    ...
    NSAttributedString *chooseYourString =
        [[NSAttributedString alloc] initWithString:NSLocalizedString(@"Choose your", @"Choose your Axe username")
    ...
    NSAttributedString *axeUsernameString =
        [[NSAttributedString alloc] initWithString:NSLocalizedString(@"Axe username", nil)
    ...
    [resultString appendAttributedString:axeUsernameString];
