...
- (id<DWTransactionListDataItem>)transactionDataForTransaction:(DSTransaction *)transaction {
    ...
    switch (transactionDirection) {
        case DSTransactionDirection_Moved: {
            dataItem.axeAmount = [account amountReceivedFromTransactionOnExternalAddresses:transaction];
            dataItem.outputReceiveAddresses = [account externalAddressesOfTransaction:transaction];
            break;
        }
        case DSTransactionDirection_Sent: {
            dataItem.axeAmount = [account amountSentByTransaction:transaction] - [account amountReceivedFromTransaction:transaction] - transaction.feeUsed;
            dataItem.outputReceiveAddresses = [account externalAddressesOfTransaction:transaction];
            break;
        }
        case DSTransactionDirection_Received: {
            dataItem.axeAmount = [account amountReceivedFromTransaction:transaction];
            dataItem.outputReceiveAddresses = [account externalAddressesOfTransaction:transaction];
            break;
        }
        case DSTransactionDirection_NotAccountFunds: {
            dataItem.axeAmount = 0;
    ...
    dataItem.fiatAmount = [priceManager localCurrencyStringForAxeAmount:dataItem.axeAmount];
