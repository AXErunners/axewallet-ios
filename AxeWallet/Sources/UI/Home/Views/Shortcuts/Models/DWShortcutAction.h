...
typedef NS_ENUM(NSInteger, DWShortcutActionType) {
    ...
    DWShortcutActionType_SyncNow = 4,
    DWShortcutActionType_PayWithNFC = 5,
    DWShortcutActionType_LocalCurrency = 6,
    DWShortcutActionType_ImportPrivateKey = 7,
    DWShortcutActionType_SwitchToTestnet = 8,
    DWShortcutActionType_SwitchToMainnet = 9,
    DWShortcutActionType_ReportAnIssue = 10,
    DWShortcutActionType_CreateUsername = 11,
    DWShortcutActionType_Receive = 12,
