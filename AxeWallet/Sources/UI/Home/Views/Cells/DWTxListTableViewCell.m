...
#import <AxeSync/DSTransaction.h>
...
- (void)awakeFromNib {
    ...
    self.axeAmountLabel.font = [UIFont dw_fontForTextStyle:UIFontTextStyleSubheadline];
...
- (void)reloadAttributedData {
    ...
    self.axeAmountLabel.attributedText = [self.dataProvider axeAmountStringFrom:self.transactionData
                                                                             font:font];
}
