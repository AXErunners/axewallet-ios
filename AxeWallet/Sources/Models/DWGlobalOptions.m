...
static NSString *const LOCKSCREEN_DISABLED_KEY = @"org.axe.wallet.lockscreen-disabled";
static NSString *const SPENDING_CONFIRMATION_DISABLED_KEY = @"org.axe.wallet.spending-confirmation-disabled";
