...
- (void)getCards:(void (^)(DWUpholdCardObject *_Nullable axeCard, NSArray<DWUpholdCardObject *> *fiatCards))completion {
    ...
    [DWUpholdAPIProvider getCardsAccessToken:self.accessToken
                                  completion:^(BOOL success, DWUpholdAPIProviderResponseStatusCode statusCode, DWUpholdCardObject *_Nullable axeCard, NSArray<DWUpholdCardObject *> *fiatCards) {
                                      __strong typeof(weakSelf) strongSelf = weakSelf;
                                      if (!strongSelf) {
                                          return;
                                      }
                                      ...
                                      if (success) {
                                          if (axeCard) {
                                              if (!axeCard.address) {
                                                  [strongSelf createAxeCardAddress:axeCard
...
- (DWUpholdCancellationToken)createTransactionForAxeCard:(DWUpholdCardObject *)card
    ...
    __weak typeof(self) weakSelf = self;
    return [DWUpholdAPIProvider createTransactionForAxeCard:card
                                                      amount:amount
                                                     address:address
...
- (DWUpholdCancellationToken)createBuyTransactionForAxeCard:(DWUpholdCardObject *)card
    ...
    __weak typeof(self) weakSelf = self;
    return [DWUpholdAPIProvider createBuyTransactionForAxeCard:card
                                                        account:account
                                                         amount:amount
...
- (void)createAxeCard:(void (^)(DWUpholdCardObject *_Nullable card))completion {
    ...
    __weak typeof(self) weakSelf = self;
    [DWUpholdAPIProvider createAxeCardAccessToken:self.accessToken
...
- (void)createAxeCardAddress:(DWUpholdCardObject *)card completion:(void (^)(DWUpholdCardObject *_Nullable card))completion {
    ...
    __weak typeof(self) weakSelf = self;
    [DWUpholdAPIProvider createAddressForAxeCard:card
                                      accessToken:self.accessToken
                                       completion:^(BOOL success, DWUpholdAPIProviderResponseStatusCode statusCode, DWUpholdCardObject *_Nullable card) {
                                           __strong typeof(weakSelf) strongSelf = weakSelf;
                                           if (!strongSelf) {
