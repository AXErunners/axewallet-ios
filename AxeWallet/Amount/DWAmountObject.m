...
#import <AxeSync/DSPriceManager.h>
#import <AxeSync/NSString+Axe.h>

NS_ASSUME_NONNULL_BEGIN

static CGSize const AxeSymbolBigSize = {24.07, 19.0};
static CGSize const AxeSymbolSmallSize = {12.67, 10.0};
...
- (instancetype)initWithAxeAmountString:(NSString *)axeAmountString {
    ...
    if (self) {
        ...
        _axeAttributedString = [_axeFormatted attributedStringForAxeSymbolWithTintColor:[UIColor whiteColor] axeSymbolSize:AxeSymbolBigSize];
...
- (nullable instancetype)initWithLocalAmountString:(NSString *)localAmountString {
    ...
    if (self) {
        ...
        _axeAttributedString = [_axeFormatted attributedStringForAxeSymbolWithTintColor:[UIColor whiteColor] axeSymbolSize:AxeSymbolSmallSize];
        _localCurrencyAttributedString = [self.class attributedStringForLocalCurrencyFormatted:_localCurrencyFormatted];
    }
    return self;
}
