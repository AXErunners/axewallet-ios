...
static NSString *const SCAN_URL = @"axewallet://x-callback-url/scanqr";
static NSString *const OPEN_URL = @"axewallet://";
...
- (void)updateReceiveMoneyUI {
    ...
    if (self.qrCodeData && self.qrImage.bounds.size.width > 0) {
        ...
        UIImage *overlayLogo = [[UIImage imageNamed:@"axe_logo_qr"] dw_resize:LOGO_SIZE
