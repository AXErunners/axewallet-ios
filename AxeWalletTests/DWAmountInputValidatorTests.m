...
- (void)setUp {
    ...
    self.axeValidator = [[DWAmountInputValidator alloc] initWithType:DWAmountInputValidatorTypeAxe];
...
- (void)testMaximumLimits {
    for (NSLocale *locale in self.locales) {
        ...
        [self performAxeValidatorTests:testCases locale:locale];
    }
}
...
- (void)performAxeValidatorTests:(NSArray<DWAmountInputTestCase *> *)testCases locale:(NSLocale *)locale {
    for (DWAmountInputTestCase *test in testCases) {
        DWAmountInputValidator *validator = [[DWAmountInputValidator alloc] initWithType:DWAmountInputValidatorTypeAxe
                                                                                  locale:locale];
